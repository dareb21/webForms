    ...
    <div class="flex h-screen relative">
        ...
        <div id="sidebar"
            ...
            <div class="flex items-center p-2 space-x-4">
                ...
                <div>
                    <h2 class="text-lg font-semibold">Vicerector USAP</h2>
            ...
            <div class="divide-y divide-gray-300">
                <ul class="pt-2 pb-4 space-y-1 text-sm">
                    <li class="hover:bg-blue-700 hover:text-white">
                        <a href="{{ route('senen.dashboard') }}" class="group flex items-center p-2 space-x-3 rounded-md">
                    ...
                    <li class="hover:bg-blue-700 hover:text-white">
                        <a href="{{ route('senen.schools') }}" class="group flex items-center p-2 space-x-3 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                class="w-5 h-5 fill-current text-gray-600 transition duration-300 group-hover:invert">
                                <path
