...
<head>
    ...
    <link rel="preload" as="image" href="{{ asset('img/survey.png') }}">
            ...
            <ul class="font-bold space-y-4">
                <li>
                    <a href="{{ route('adminDashboard') }}" class="group flex items-center p-4 px-6 gap-2 hover:rounded-lg hover:bg-blue-500 hover:text-white">
                        <img src="{{ asset('img/home.png') }}" alt="" class="w-5 h-5 group-hover:invert group-hover:brightness-0 group-hover:contrast-200" loading="eager">Inicio
                    </a>
                </li>
                <li>
                    <a href="{{  route('adminEvaluation') }}" class="group flex items-center p-4 px-6 gap-2 hover:rounded-lg hover:bg-blue-500 hover:text-white">
                        <img src="{{ asset('img/survey.png') }}" alt="" class="w-5 h-5 group-hover:invert group-hover:brightness-0 group-hover:contrast-200" loading="eager">Evaluaciones
                    </a>
                </li>
                <li>
                    <a href="{{ route('adminResults') }}" class="group flex items-center p-4 px-6 gap-2 hover:rounded-lg hover:bg-blue-500 hover:text-white">
                        <img src="{{ asset('img/results.png') }}" alt="" class="w-5 h-5 group-hover:invert group-hover:brightness-0 group-hover:contrast-200" loading="eager">Resultados
                    </a>
                </li>
            </ul>
        </div>
