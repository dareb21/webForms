    ...
    <div class="bg-white rounded-xl shadow-lg p-6 w-full h-full relative pb-24">
        ...
        <form id="form-evaluacion" action="{{ route('createNewEvaluation') }}" method="POST">
            ...
            <div class="flex justify-start gap-x-4 flex-wrap py-4">
                ...
                <input type="date" name="dateStart" class="shadow-md border border-gray-200">
                <label for="">Fecha Cierre -</label>
                <input type="date" name="dateEnd" class="shadow-md border border-gray-200">
            </div>
        ...
        <div class="w-full flex justify-center md:justify-center gap-4 flex-col md:flex-row py-4 bg-white rounded-b-xl mt-8">
            <!-- GUARDAR a la izquierda -->
            <button onclick="document.getElementById('form-evaluacion').submit()" class="hover:cursor-pointer bg-blue-600 hover:bg-orange-500 text-white font-bold py-1 px-6 rounded">
                GUARDAR
            </button>
