    ...
    <div class="flex-1 h-full md:ml-64 p-6 bg-gray-200 min-h-[calc(100vh-4rem)] overflow-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-white p-4 rounded-lg shadow-md">
                <p class="text-gray-500">Evaluacion Decano</p>
                <h2 class="text-2xl font-bold">300</h2>
                <canvas id="chart1" height="40"></canvas>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-md">
                <p class="text-gray-500">Estudiantes Decano</p>
                <h2 class="text-2xl font-bold">300</h2>
                <canvas id="chart2" height="40"></canvas>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-md">
                <p class="text-gray-500">Directores Decano</p>
                <h2 class="text-2xl font-bold">300</h2>
                <canvas id="chart3" height="40"></canvas>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-md">
                <p class="text-gray-500">Ejemplo Decano</p>
                <h2 class="text-2xl font-bold">300</h2>
