...
<body class="bg-gray-100">
    ...
    <div class="flex h-screen relative">
        <!-- Sidebar -->
        <div id="sidebar"
            class="fixed top-0 left-0 h-full w-60 p-3 space-y-2 bg-white z-40 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out">
            <div class="flex items-center p-2 space-x-4">
                <img src="{{ asset('img/pfp.jpg') }}" alt="" class="w-12 h-12 rounded-full bg-gray-300" />
                <div>
                    <h2 class="text-lg font-semibold">Dean USAP</h2>
                    <span class="text-sm font-light">dean@usap.edu</span>
                </div>
            </div>
            ...
            <div class="divide-y divide-gray-300">
                <ul class="pt-2 pb-4 space-y-1 text-sm">
                    <li class="hover:bg-blue-700 hover:text-white">
                        <a href="{{ route('deanDashboard') }}" class="group flex items-center p-2 space-x-3 rounded-md">
                    ...
                    <li class="hover:bg-blue-700 hover:text-white">
                        <a href="{{ route('deanSchools') }}" class="group flex items-center p-2 space-x-3 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                class="w-5 h-5 fill-current text-gray-600 transition duration-300 group-hover:invert">
                                <path
                                    d="M479.6,399.716l-81.084-81.084-62.368-25.767A175.014,175.014,0,0,0,368,192c0-97.047-78.953-176-176-176S16,94.953,16,192,94.953,368,192,368a175.034,175.034,0,0,0,101.619-32.377l25.7,62.2L400.4,478.911a56,56,0,1,0,79.2-79.195ZM48,192c0-79.4,64.6-144,144-144s144,64.6,144,144S271.4,336,192,336,48,271.4,48,192ZM456.971,456.284a24.028,24.028,0,0,1-33.942,0l-76.572-76.572-23.894-57.835L380.4,345.771l76.573,76.572A24.028,24.028,0,0,1,456.971,456.284Z" />
                            </svg>
                            <span>Resultados Escuelas</span>
                        </a>
                    </li>
                </ul>
