...
<!-- Main Content -->
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-white p-4 rounded-lg shadow-md">
                <p class="text-gray-500">Encuestas Director</p>
                <h2 class="text-2xl font-bold">300</h2>
                <canvas id="chart1" height="40"></canvas>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-md">
                <p class="text-gray-500">Evaluacion Director</p>
                <h2 class="text-2xl font-bold">300</h2>
                <canvas id="chart2" height="40"></canvas>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-md">
                <p class="text-gray-500">Directores Director</p>
                <h2 class="text-2xl font-bold">300</h2>
                <canvas id="chart3" height="40"></canvas>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-md">
                <p class="text-gray-500">Ejemplo Director</p>
                <h2 class="text-2xl font-bold">300</h2>
