    ...
    <div class="bg-white rounded-xl shadow-lg p-6 w-full h-full">
        <div class="flex flex-col items-center">
            ...
            <div class="flex justify-center gap-x-4 flex-wrap py-4">
                ...
                <input type="text" name="directorSearch" id="directorSearch" class="shadow-md border border-gray-200">
                <select name="directorSearchSelect" id="directorSearchSelect" class="shadow-md border border-gray-200">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border border-gray-400 px-4 py-2 text-center">
                                <a href="{{ route('directorStudentView') }}" class="bg-orange-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded">
                                    VER
                                </a>
                            </td>
                            <td class="border border-gray-400 px-4 py-2 text-center">
