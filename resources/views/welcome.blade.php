...
<body>
    <div class="flex h-screen">
        <!-- Imagen izq -->
        <div
            class="relative h-screen w-full md:w-xl p-1 bg-[url('/public/img/backgroundusap.png')] bg-left bg-cover bg-no-repeat">
            <!-- Logo centrado -->
            ...
            <div class="absolute bottom-50 left-1/2 transform -translate-x-1/2 z-50">
                ...
                <form action="{{ route('login') }}">
                    @csrf
                    <button
                        class="flex items-center justify-center gap-2 border-2 px-30 py-2 rounded-2xl shadow-xl border-amber-600 bg-amber-600 text-white font-bold hover:cursor-pointer">
